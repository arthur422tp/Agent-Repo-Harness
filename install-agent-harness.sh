...
echo "3. Review $target/.agent/task.yml and set task scope if needed."
echo "4. Run: cd $target && bash scripts/agent-preflight.sh"
echo "5. Run: cd $target && bash scripts/check-agent-md.sh agent.md"
echo "6. Run: cd $target && bash scripts/check-policy.sh"
echo "7. Run: cd $target && bash scripts/check-scope.sh"
echo "8. Run: cd $target && bash scripts/agent-verify.sh"
echo "9. Run before completion: cd $target && bash scripts/agent-finish.sh"
