...
echo "6. Run: cd $target && bash scripts/agent-preflight.sh"
echo "7. Run: cd $target && bash scripts/validate-config.sh"
echo "8. Run: cd $target && bash scripts/validate-task.sh"
echo "9. Run: cd $target && bash scripts/check-policy.sh"
echo "10. Run: cd $target && bash scripts/check-scope.sh"
echo "11. Run: cd $target && bash scripts/check-tdd-evidence.sh"
echo "12. Run: cd $target && bash scripts/agent-verify.sh"
echo "13. Run before completion: cd $target && bash scripts/agent-finish.sh"
