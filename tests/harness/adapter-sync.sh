...
assert_contains "$repo_root/adapters/codex/codex-repair-prompt.md" 'docs/agent/repair-failed-run.md'
...
assert_contains "$repo_root/adapters/codex/codex-repair-prompt.md" 'failure-attribution-result.txt'
assert_contains "$repo_root/adapters/codex/codex-repair-prompt.md" 'failure_attribution.root_cause'
assert_contains "$repo_root/adapters/codex/codex-repair-prompt.md" '.agent/failure-attribution.yml'
...
assert_contains "$repo_root/adapters/codex/codex-verify-prompt.md" 'episode-summary.json'
assert_contains "$repo_root/adapters/codex/codex-verify-prompt.md" 'failure-attribution-result.txt'
assert_contains "$repo_root/adapters/codex/codex-verify-prompt.md" 'interventions-result.txt'
...
assert_contains "$repo_root/adapters/codex/codex-handoff-prompt.md" 'episode-summary.json'
assert_contains "$repo_root/adapters/codex/codex-handoff-prompt.md" 'failure attribution'
assert_contains "$repo_root/adapters/codex/codex-handoff-prompt.md" 'intervention'
